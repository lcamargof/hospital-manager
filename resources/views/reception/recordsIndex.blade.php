	...
	<div class="panel panel-default">
		<div class="panel-heading"><i class="fa fa-book"></i> Records
			<div class="btnmenu pull-right">
				<div class="btn-group" >
					<button type="button" class="btn btn-default" id="recordPayBtn"><i class="fa fa-credit-card"></i> Pay</button>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" id="doctor" name="doctor" class="form-control" placeholder="Find the doctor" readonly="readonly">
							      <span class="input-group-btn">
							        <button class="btn btn-default" id="doctorSelectBtn" type="button"><i class="fa fa-search"></i></button>
							      </span>										
								</div>
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="input-group">
								   <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
									<input type="text" id="date_to" readonly="readonly" name="date_to" class="form-control" placeholder="YYYY-MM-DD">
								</div>
							</div>
						</div>
						<div class="col-md-12">
...
<div class="modal fade" id="recordDeleteModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				<button type="button" class="btn btn-danger" id="deleteRecordtBtn">Confirm</button>
			</div>
		</div>
	</div>
</div>

<div class="modal fade" id="recordPayModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="amount" id="amount" placeholder="Aumont to pay" class="form-control">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				<button type="button" class="btn btn-success" id="payRecordtConfirm">Confirm payment</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="doctorCalendarModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Doctor selection</h4>
			</div>
			<div class="modal-body">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				<button type="button" class="btn btn-primary" id="selectedDoctorBtn">Save changes</button>
			</div>
		</div>
	</div>
</div>
